    ...
    <div className="flex h-full flex-col" style={{ fontSize: "var(--font-sidebar)" }}>
      ...
      <div className="space-y-1.5 border-t border-border p-2">
        <button
          ...
          className="flex w-full items-center border-none gap-2 rounded-md py-2 pl-3 text-accent font-medium text-sm hover:bg-[var(--c-3d2413)]"
        >
        ...
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md border border-[var(--c-6a3919)] bg-[var(--c-1d140e)] py-2 pl-3 text-accent font-medium text-sm hover:bg-[var(--c-28190e)]"
        >
